    ...
    <div>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="text-right">
          <h2 className="text-lg font-medium">Hritik Shukla</h2>
          <h4 className="text-xl font-semibold -mt-1 -mb-1">MP4 DHWJ 223</h4>
          <p className="text-sm text-gray-400">Prahlad Nagar Bhopal</p>
        </div>
      </div>
